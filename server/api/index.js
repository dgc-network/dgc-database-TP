...
router.get('/participants', handle(participants.list))
router.get('/participants/:publicKey', handle(participants.fetch))
router.post('/createParticipant', handleBody(participants.create))
//router.post('/updateParticipants', handleBody(participants.update))

router.post('/authorization', handleBody(auth.authorize))
router.post('/makePrivateKey', handleBody(auth.makePrivateKey))
//router.post('/encryptKey', handleBody(auth.encryptKey))

router.post('/createTables', handleBody(tables.create))

router.post('/createRecord', handleBody(records.createRecord))
router.post('/updateRecords', handleBody(records.updateRecords))
router.post('/retrieveRecords', handleBody(records.retrieveRecords))
router.post('/deleteRecords', handleBody(records.deleteRecords))

router.post('/applyDGCoinCredit', handleBody(proposals.applyDGCoinCredit))
router.post('/buyDGCoinProposal', handleBody(proposals.buyDGCoinProposal))
router.post('/sellDGCoinProposal', handleBody(proposals.sellDGCoinProposal))
router.post('/transferDGCoinProposal', handleBody(proposals.transferDGCoinProposal))
router.post('/answerDGCoinTransfer', handleBody(proposals.answerDGCoinTransfer))
router.post('/transferCustodianship', handleBody(proposals.transferCustodianshipProposal))
router.post('/retrieveProposals', handleBody(proposals.retrieveProposals))
router.get('/proposals', handle(proposals.list))

router.post('/lastExchange', handleBody(exchanges.last))
router.post('/retrieveExchanges', handleBody(exchanges.retrieve))
router.get('/exchanges', handle(exchanges.list))
...
router.get('/tables', handle(tables.list))
router.get('/tables/:name', handle(tables.fetch))

router.post('/transactions', handleBody(blockchain.submit))

router.post('/isUsernameExists', handleBody(users.retrieve))
